...
class AccessControl:
    ...
    def __call__(self, permissions: str) -> Type[Callable]:
    ...
    def assert_access(self, principals: list, permissions: str, resource: Any) -> Any:
    ...
    def has_permission(
        self, principals: List[Principal], required_permissions: List, resource: Any
    ) -> bool:
